...
declare module 'gi://GstCodecParsers?version=1.0' {
    ...
    export namespace GstCodecParsers {
        ...
        class Vp9BitDepth {
            ...
            /**
             * Bit depth is 8
             * `GST_VP9`_BIT_DEPTH_10 Bit depth is 10
             */
            static '8': number;
            static '10': number;
            /**
         ...
         *
         * This differs from `gst_h2`64_parser_identify_nalu in that it doesn't
         * check whether the packet is complete or not.
         *
         * Note: Only use this function if you already know the provided `data`
         * is a complete NALU, else use `gst_h2`64_parser_identify_nalu.
         * @param nalparser a #GstH264NalParser
         * @param data The data to parse
        ...
        class H265Parser {
             ...
             * Parses `data` and fills `nalu` from the next nalu data from `data`.
             *
             * This differs from `gst_h2`65_parser_identify_nalu in that it doesn't
             * check whether the packet is complete or not.
             *
             * Note: Only use this function if you already know the provided `data`
             * is a complete NALU, else use `gst_h2`65_parser_identify_nalu.
             * @param data The data to parse
             * @param offset the offset from which to parse @data
             * @param size the size of @data
             * @param nalu The #GstH265NalUnit where to store parsed nal headers
        ...
        class H266Parser {
             ...
             * Parses `data` and fills `nalu` from the next nalu data from `data`.
             *
             * This differs from `gst_h2`66_parser_identify_nalu in that it doesn't
             * check whether the packet is complete or not.
             *
             * Note: Only use this function if you already know the provided `data`
             * is a complete NALU, else use `gst_h2`66_parser_identify_nalu.
             * @param data The data to parse
             * @param offset the offset from which to parse @data
             * @param size the size of @data
             * @param nalu The #GstH266NalUnit where to store parsed nal headers
